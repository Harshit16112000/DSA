...
private:
    ...
    unordered_map<string, double> getMaxAmounts(string startCurrency, unordered_map<string, unordered_map<string, double>>& graph, unordered_map<string, double>& initialAmounts) 
    {
